...
var WINDOW_HEIGHT = exports.WINDOW_HEIGHT = window.innerHeight;
...
var CanvasParticlesHelper = function () {
    function CanvasParticlesHelper() {
        _classCallCheck(this, CanvasParticlesHelper);
    }

    _createClass(CanvasParticlesHelper, null, [{
        key: 'getCtx',
        value: function getCtx(canvas_id) {
            return document.getElementById(canvas_id).getContext('2d');
        }
    }]);

    return CanvasParticlesHelper;
}();

exports.default = CanvasParticlesHelper;
...
exports.Particle = exports.Canvas = undefined;
...
var _CanvasHelper = __webpack_require__(15);
...
var Canvas = exports.Canvas = function (_React$Component) {
    ...
    _createClass(Canvas, [{
        ...
        value: function componentDidMount() {
            ...
            this.context = _CanvasHelper2.default.getCtx(this.props.context);
            this.refs.canvas.height = _Constants.WINDOW_HEIGHT;
            this.refs.canvas.width = _Constants.WINDOW_WIDTH;
        ...
        value: function paintCanvas() {
            var grd = this.context.createLinearGradient(0, 0, 0, _Constants.WINDOW_HEIGHT);
            grd.addColorStop(0, '#355C7D');
            grd.addColorStop(0.5, '#6C5B7B');
            grd.addColorStop(1, '#C06C84');
            this.context.fillStyle = grd;
            this.context.fillRect(0, 0, _Constants.WINDOW_WIDTH, _Constants.WINDOW_HEIGHT);
        }
    }, {
        key: "drawParticles",
...
*/
'use strict';var aa=__webpack_require__(4),ba=__webpack_require__(1),m=__webpack_require__(6),p=__webpack_require__(5),v=__webpack_require__(2),da=__webpack_require__(8),ea=__webpack_require__(9),fa=__webpack_require__(7),ha=__webpack_require__(3);
...
exports.ProfilePageCanvasAnimation = undefined;
...
var ProfilePageCanvasAnimation = exports.ProfilePageCanvasAnimation = function (_Canvas) {
    _inherits(ProfilePageCanvasAnimation, _Canvas);

    function ProfilePageCanvasAnimation() {
        _classCallCheck(this, ProfilePageCanvasAnimation);

        return _possibleConstructorReturn(this, (ProfilePageCanvasAnimation.__proto__ || Object.getPrototypeOf(ProfilePageCanvasAnimation)).apply(this, arguments));
    }

    _createClass(ProfilePageCanvasAnimation, [{
        key: "CreateParticles",
        value: function CreateParticles() {
            var col = Math.floor(this.refs.canvas.width / this.particle_count);
            var row = Math.floor(this.refs.canvas.height / this.particle_count);
            var col_corrector = (this.particle_count + (this.refs.canvas.width - col * this.particle_count)) / 2;
            var row_corrector = (this.particle_count + (this.refs.canvas.height - row * this.particle_count)) / 2;

            this.particles = [];
            for (var i = 0; i < col; ++i) {
                for (var j = 0; j < row; ++j) {
                    var x = i * this.particle_count + col_corrector;
                    var y = j * this.particle_count + row_corrector;
        ...
        value: function update() {
            for (var i = 0; i < this.particles.length; ++i) {
                var r = 1;
                var x = this.particles[i].x - r;
                var y = this.particles[i].y - r;
        ...
        value: function render() {
            return _react2.default.createElement("canvas", { ref: "canvas", id: this.props.context });
        }
    }]);

    return ProfilePageCanvasAnimation;
}(_canvas.Canvas);

var LerpParticle = function (_Particle) {
    _inherits(LerpParticle, _Particle);

    function LerpParticle(x, y, radius, color, context) {
        _classCallCheck(this, LerpParticle);

        var _this2 = _possibleConstructorReturn(this, (LerpParticle.__proto__ || Object.getPrototypeOf(LerpParticle)).call(this));

        _this2.x = _this2.currentX = _this2.targetX = x;
        _this2.y = _this2.currentY = _this2.targetY = y;
        _this2.color = color;
...
exports.ProfileCardContentCategories = exports.ProfileCardContentCategoryType = undefined;
...
var ProfileCardContentCategoryType = exports.ProfileCardContentCategoryType = function (_React$Component) {
    _inherits(ProfileCardContentCategoryType, _React$Component);

    function ProfileCardContentCategoryType() {
        _classCallCheck(this, ProfileCardContentCategoryType);

        return _possibleConstructorReturn(this, (ProfileCardContentCategoryType.__proto__ || Object.getPrototypeOf(ProfileCardContentCategoryType)).apply(this, arguments));
    }

    _createClass(ProfileCardContentCategoryType, [{
        key: "switchCase",
        value: function switchCase(name) {
            switch (name) {
                case "event":
                    {
                        console.log("event");
        ...
        value: function interest() {
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    "h1",
                    { className: "interest_name" },
                    this.props.interest_name
                ),
                _react2.default.createElement(
                    "div",
                    { className: "interest_image" },
                    _react2.default.createElement("img", { src: "", className: "interest_image" })
                )
            );
        }
    }, {
        ...
        value: function activity() {
            return _react2.default.createElement("div", { id: "activity" });
        }
    }, {
        key: "render",
        value: function render() {
            return _react2.default.createElement(
                "div",
                { className: "categories_translate" },
                _react2.default.createElement(
                    "div",
                    { className: "profile_card_content_category_type_padding" },
                    _react2.default.createElement(
                        "div",
                        { className: "profile_card_content_category_type" },
    ...
    return ProfileCardContentCategoryType;
}(_react2.default.Component);

var ProfileCardContentCategories = exports.ProfileCardContentCategories = function (_React$Component2) {
    _inherits(ProfileCardContentCategories, _React$Component2);

    function ProfileCardContentCategories() {
        _classCallCheck(this, ProfileCardContentCategories);

        var _this2 = _possibleConstructorReturn(this, (ProfileCardContentCategories.__proto__ || Object.getPrototypeOf(ProfileCardContentCategories)).call(this));

        _this2.nextCategory = _this2.nextCategory.bind(_this2);
        _this2.state = {
            categories_details: [{
                visibility: true
            }, {
    ...
    _createClass(ProfileCardContentCategories, [{
        key: "nextCategory",
        value: function nextCategory(index) {
            console.log("nextCategory");
            var categories_details_copy = this.state.categories_details;
            var category_div_width = document.querySelector(".profile_card_content_category_type_padding").offsetWidth;
            var category_types_list = document.querySelectorAll(".categories_translate");
            var category_animation_controller_buttons_list = document.querySelectorAll(".border");

            for (var i = 0; i < categories_details_copy.length; ++i) {
                if (i === index) {
            ...
            for (var _i = 0; _i < category_types_list.length; ++_i) {
                category_types_list[_i].style.transform = "translateX(-" + category_div_width * index + "px)";
            }
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    "div",
                    { className: "profile_page_card_content_categories_list" },
                    _react2.default.createElement(
                        "div",
                        { className: "cl_item evt" },
                        _react2.default.createElement(
                            "a",
                            { className: "active border", onClick: function onClick() {
                                    _this3.nextCategory(0);
                                } },
                            "Events List"
                        )
                    ),
                    _react2.default.createElement(
                        "div",
                        { className: "cl_item int" },
                        _react2.default.createElement(
                            "a",
                            { className: "border", onClick: function onClick() {
                                    _this3.nextCategory(1);
                                } },
                            "Connections"
                        )
                    ),
                    _react2.default.createElement(
                        "div",
                        { className: "cl_item act" },
                        _react2.default.createElement(
                            "a",
                            { className: "border", onClick: function onClick() {
                                    _this3.nextCategory(2);
                                } },
                            "Activity Stats"
                        )
                    )
                ...
                _react2.default.createElement(
                    "div",
                    { className: "profile_page_card_content_categories" },
                    _react2.default.createElement(
                        "div",
                        { id: "event_category_section", className: "profile_card_content_category_type_style" },
                        _react2.default.createElement(ProfileCardContentCategoryType, {
                            category_type: "event",
                            event_title: "Party-1",
                    ...
                    _react2.default.createElement(
                        "div",
                        { id: "interest_category_section", className: "profile_card_content_category_type_style" },
                        _react2.default.createElement(ProfileCardContentCategoryType, {
                            category_type: "event",
                            event_title: "Party-3",
                            event_about: "lorem ipsum dolor....",
    ...
    return ProfileCardContentCategories;
}(_react2.default.Component);
...
exports.ProfileCardHeaderInfo = exports.ProfileCardHeaderSearch = exports.ProfileCardHeaderTitle = exports.ProfileCardHeaderHamburger = undefined;
...
var ProfileCardHeaderHamburger = exports.ProfileCardHeaderHamburger = function ProfileCardHeaderHamburger() {
    return _react2.default.createElement(
        "div",
        { className: "profile_page_card_header_hamburger" },
        _react2.default.createElement("div", { className: "hmb_line" }),
        _react2.default.createElement("div", { className: "hmb_line short" }),
        _react2.default.createElement("div", { className: "hmb_line" })
    );
};

var ProfileCardHeaderTitle = exports.ProfileCardHeaderTitle = function ProfileCardHeaderTitle() {
    return _react2.default.createElement(
        "div",
        { className: "profile_page_card_header_title" },
        _react2.default.createElement(
            "span",
            null,
            "PROFILE"
...
var ProfileCardHeaderSearch = exports.ProfileCardHeaderSearch = function ProfileCardHeaderSearch() {
    return _react2.default.createElement(
        "div",
        { className: "profile_page_card_header_search" },
        _react2.default.createElement(
            "span",
            null,
...
var ProfileCardHeaderInfo = exports.ProfileCardHeaderInfo = function ProfileCardHeaderInfo() {
    return _react2.default.createElement(
        "div",
        { className: "profile_page_card_header_info" },
        _react2.default.createElement("div", { className: "pr_image_style" }),
        _react2.default.createElement(
            "div",
...
var _card_header_components = __webpack_require__(35);

var _card_content_components = __webpack_require__(34);

var _profile_page_canvas = __webpack_require__(33);
...
var ProfileCardStrangerHeader = function (_React$Component) {
    _inherits(ProfileCardStrangerHeader, _React$Component);

    function ProfileCardStrangerHeader() {
        _classCallCheck(this, ProfileCardStrangerHeader);

        return _possibleConstructorReturn(this, (ProfileCardStrangerHeader.__proto__ || Object.getPrototypeOf(ProfileCardStrangerHeader)).apply(this, arguments));
    }

    _createClass(ProfileCardStrangerHeader, [{
        key: 'render',
        value: function render() {
            return _react2.default.createElement(
                'div',
                { className: 'profile_page_card_header_style profile_page_card_style' },
                _react2.default.createElement('div', { className: 'dark' }),
                _react2.default.createElement(
                    'div',
                    { className: 'card_header_functional_section' },
                    _react2.default.createElement(_card_header_components.ProfileCardHeaderHamburger, null),
                    _react2.default.createElement(_card_header_components.ProfileCardHeaderSearch, null)
                ),
                _react2.default.createElement(
                    'div',
                    { className: 'card_header_profile_info_section' },
                    _react2.default.createElement(_card_header_components.ProfileCardHeaderInfo, null)
                )
            );
        }
    }]);

    return ProfileCardStrangerHeader;
}(_react2.default.Component);

var ProfileCardStrangerContent = function (_React$Component2) {
    _inherits(ProfileCardStrangerContent, _React$Component2);

    function ProfileCardStrangerContent() {
        _classCallCheck(this, ProfileCardStrangerContent);

        return _possibleConstructorReturn(this, (ProfileCardStrangerContent.__proto__ || Object.getPrototypeOf(ProfileCardStrangerContent)).apply(this, arguments));
    }

    _createClass(ProfileCardStrangerContent, [{
        key: 'render',
        value: function render() {
            return _react2.default.createElement(
                'div',
                { className: 'profile_page_card_content_style profile_page_card_style' },
                _react2.default.createElement(_card_content_components.ProfileCardContentCategories, null)
            );
        }
    }]);

    return ProfileCardStrangerContent;
}(_react2.default.Component);

var ProfileCardStrangerCard = function (_React$Component3) {
    _inherits(ProfileCardStrangerCard, _React$Component3);

    function ProfileCardStrangerCard() {
        _classCallCheck(this, ProfileCardStrangerCard);

        return _possibleConstructorReturn(this, (ProfileCardStrangerCard.__proto__ || Object.getPrototypeOf(ProfileCardStrangerCard)).call(this));
    }

    _createClass(ProfileCardStrangerCard, [{
        key: 'render',
        value: function render() {
            return _react2.default.createElement(
                'div',
                { className: 'profile_card pos_abs' },
                _react2.default.createElement(
                    'div',
                    { className: 'profile_page_card_flex' },
                    this.props.children
                )
            );
        }
    ...
    return ProfileCardStrangerCard;
}(_react2.default.Component);
        ...
        value: function render() {
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    null,
                    _react2.default.createElement(ProfileCardStrangerHeader, null),
                    _react2.default.createElement(ProfileCardStrangerContent, null)
                ),
                _react2.default.createElement(_profile_page_canvas.ProfilePageCanvasAnimation, { context: "profile_canvas", prt_count: 50 })
            );
        }
    }]);
...
_reactDom2.default.render(_react2.default.createElement(ProfilePage, null), document.getElementById("profile"));
