...
exports.RandomMovingParticle = exports.LoginRegisterPageCanvasAnimation = undefined;
...
var LoginRegisterPageCanvasAnimation = exports.LoginRegisterPageCanvasAnimation = function (_Canvas) {
    _inherits(LoginRegisterPageCanvasAnimation, _Canvas);

    function LoginRegisterPageCanvasAnimation() {
        _classCallCheck(this, LoginRegisterPageCanvasAnimation);

        return _possibleConstructorReturn(this, (LoginRegisterPageCanvasAnimation.__proto__ || Object.getPrototypeOf(LoginRegisterPageCanvasAnimation)).apply(this, arguments));
    }

    _createClass(LoginRegisterPageCanvasAnimation, [{
        key: "CreateParticles",
        value: function CreateParticles() {
            this.particles = [];
            for (var i = 0; i < this.particle_count; ++i) {
                this.particles.push(new RandomMovingParticle(Math.random() * _Constants.WINDOW_WIDTH, Math.random() * _Constants.WINDOW_HEIGHT, 4, "#9e9e9ed4", this.context));
                this.particles[i].draw();
            }
        }
    }, {
        ...
        value: function update() {
            for (var i = 0; i < this.particles.length; ++i) {
                ...
                if (this.particles[i].currentX + this.particles[i].radius > _Constants.WINDOW_WIDTH) {
                    this.particles[i].currentX = this.particles[i].radius;
                } else if (this.particles[i].currentX - this.particles[i].radius < 0) {
                    this.particles[i].currentX = _Constants.WINDOW_WIDTH - this.particles[i].radius;
                }

                if (this.particles[i].currentY + this.particles[i].radius > _Constants.WINDOW_HEIGHT) {
                    this.particles[i].currentY = this.particles[i].radius;
                } else if (this.particles[i].currentY - this.particles[i].radius < 0) {
                    this.particles[i].currentY = _Constants.WINDOW_HEIGHT - this.particles[i].radius;
                }
    ...
    return LoginRegisterPageCanvasAnimation;
}(_canvas.Canvas);

var RandomMovingParticle = exports.RandomMovingParticle = function (_Particle) {
    _inherits(RandomMovingParticle, _Particle);

    function RandomMovingParticle(x, y, radius, color, context) {
        _classCallCheck(this, RandomMovingParticle);

        var _this2 = _possibleConstructorReturn(this, (RandomMovingParticle.__proto__ || Object.getPrototypeOf(RandomMovingParticle)).call(this));
...
var _login_register_page_canvas = __webpack_require__(32);
...
var SingUpForm = function (_React$Component) {
    _inherits(SingUpForm, _React$Component);

    function SingUpForm() {
        _classCallCheck(this, SingUpForm);

        return _possibleConstructorReturn(this, (SingUpForm.__proto__ || Object.getPrototypeOf(SingUpForm)).call(this));
    }

    _createClass(SingUpForm, [{
        key: 'render',
        value: function render() {
            return _react2.default.createElement(
                'div',
                { className: 'sign_up pos_abs' },
                _react2.default.createElement(
                    'div',
                    { className: 'home_form_common_style__container' },
                    _react2.default.createElement(
                        'div',
                        { className: 'home_wrap_form_common_style' },
                        _react2.default.createElement(
                            'form',
                            { method: 'POST', action: '/', className: 'home_form_common_style_form' },
                            _react2.default.createElement(
                                'span',
                                { className: 'home_form_common_style_form_title' },
                                'SIGN UP'
                            ),
                            _react2.default.createElement(
                                'div',
                                { className: 'home_form_common_style_form_input_div' },
                                _react2.default.createElement('input', { className: 'home_form_common_style_form_input', name: 'username', type: 'text', placeholder: 'Username' }),
                                _react2.default.createElement(
                                    'span',
                                    { className: 'home_form_common_style_form_icon' },
                            ...
                            _react2.default.createElement(
                                'div',
                                { className: 'home_form_common_style_form_input_div' },
                                _react2.default.createElement('input', { className: 'home_form_common_style_form_input', name: 'email', type: 'text', placeholder: 'Email' }),
                                _react2.default.createElement(
                                    'span',
                                    { className: 'home_form_common_style_form_icon' },
                            ...
                            _react2.default.createElement(
                                'div',
                                { className: 'home_form_common_style_form_input_div' },
                                _react2.default.createElement('input', { className: 'home_form_common_style_form_input', name: 'password', type: 'password', placeholder: 'Password' }),
                                _react2.default.createElement(
                                    'span',
                                    { className: 'home_form_common_style_form_icon' },
                            ...
                            _react2.default.createElement(
                                'div',
                                { className: 'home_form_common_style_form_input_div' },
                                _react2.default.createElement('input', { className: 'home_form_common_style_form_input', name: 'confirm_pass', type: 'password', placeholder: 'Confirm Password' }),
                                _react2.default.createElement(
                                    'span',
                                    { className: 'home_form_common_style_form_icon' },
                                    _react2.default.createElement('i', { className: 'fas fa-check-double' })
                                )
                            ),
                            _react2.default.createElement(
                                'div',
                                { className: 'home_form_common_style_form_btn' },
                                _react2.default.createElement(
                                    'button',
                                    null,
                                    'SIGN UP'
                            ...
                            _react2.default.createElement(
                                ...
                                _react2.default.createElement(
                                    ...
                                    _react2.default.createElement(
                                        'a',
                                        { href: '/login', className: 'login_link' },
                                        'Login'
                                    )
                                )
                            )
    ...
    _createClass(HomePage, [{
        ...
        value: function render() {
            return _react2.default.createElement(
                'div',
                null,
                _react2.default.createElement(SingUpForm, null),
                _react2.default.createElement(_login_register_page_canvas.LoginRegisterPageCanvasAnimation, { context: "common_canvas", prt_count: 140, min_dist: 120, fill_dist: "rgba(158, 98, 238, 0.7)" })
            );
        }
    }]);
...
_reactDom2.default.render(_react2.default.createElement(HomePage, null), document.getElementById("home"));
